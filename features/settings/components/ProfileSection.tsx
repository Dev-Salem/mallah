    ...
    return (
        <div className="border border-border bg-card p-6 lg:p-8 space-y-10">
            ...
            <section className="space-y-6">
                <div className="flex items-center gap-2 pb-2 border-b border-border/50">
                    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                        {t('Profile.Groups.Identity.title') || (isArabic ? 'الهوية' : 'Identity')}
                    </span>
                </div>
            ...
            <section className="space-y-6">
                <div className="flex items-center gap-2 pb-2 border-b border-border/50">
                    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                        {t('Profile.Groups.Background.title') || (isArabic ? 'الخلفية والأهداف' : 'Background & Goals')}
                    </span>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                    {/* Background Type */}
            ...
            <section className="space-y-6">
                <div className="flex items-center gap-2 pb-2 border-b border-border/50">
                    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                        {t('Profile.Groups.LearningAI.title') || (isArabic ? 'التعلم والذكاء الاصطناعي' : 'Learning & AI')}
                    </span>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                    {/* Weekly Hours */}
