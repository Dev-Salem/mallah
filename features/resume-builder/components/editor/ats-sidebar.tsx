    ...
    return (
        <aside className="w-[300px] border-r bg-background flex flex-col overflow-y-auto shrink-0 z-10 shadow-sm">
            <div className="p-6 border-b text-center space-y-4">
                <h3 className="font-semibold text-lg">{t("ATSScore")}</h3>
            ...
            <div className="p-4 flex-1">
                <h4 className="font-medium text-sm text-muted-foreground mb-4 uppercase tracking-wider">{t("ActionableHints")}</h4>
                {hints.length === 0 ? (
