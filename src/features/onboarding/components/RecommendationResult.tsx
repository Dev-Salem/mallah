...
import { CheckCircle2, TrendingUp, Calendar, Target, ArrowRight } from "lucide-react";
...
export function RecommendationResult({ recommendation }: Props) {
    ...
    return (
        ...
        >
            <div className="text-center space-y-4">
                ...
                <h1 className="text-4xl font-serif text-slate-100">Your Navigational Path: {recommendation.recommended_path_id.toUpperCase()}</h1>
                ...
                <Card className="bg-slate-900/50 border-slate-800 backdrop-blur-sm md:col-span-2">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="mt-6 p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                            <h4 className="text-sm font-semibold text-slate-400 mb-2">OPERATIONAL PREVIEW</h4>
                            <p className="text-slate-300 text-sm leading-relaxed">{recommendation.explanation.what_this_path_looks_like}</p>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="space-y-6">
                        {recommendation.starter_plan_2_weeks.map((plan: any, i: number) => (
                            <div key={i} className="space-y-2">
                                <h4 className="text-xs font-mono text-cyan-500 uppercase tracking-widest">Week {plan.week}</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {recommendation.alternatives?.length > 0 && (
                    <div className="space-y-4">
                        <h4 className="text-xs font-mono text-slate-500 uppercase">Alternative Paths Considerered</h4>
            ...
            <div className="flex justify-center pt-8">
                <Link href={`/${locale}/dashboard`}>
                    <Button size="lg" className="bg-cyan-600 hover:bg-cyan-500 text-white min-w-[200px] h-14 text-lg">
                        Accept Recommendation & Enter Command Center
