...
export default async function DashboardPage() {
  ...
  return (
    <div className="relative min-h-screen bg-background p-6 lg:p-12 overflow-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto pt-20">
